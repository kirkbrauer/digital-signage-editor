...
var Sizeable = /** @class */ (function () {
    ...
    Sizeable.calculateBoundingBox = function (sizeables) {
        var x = Sizeable.calculateX(sizeables);
        var y = Sizeable.calculateY(sizeables);
    ...
    Sizeable.calculateX = function (sizeables) {
        ...
        var minX = sizeables.get(0).getBoundingBox().x;
        try {
    ...
    Sizeable.calculateY = function (sizeables) {
        ...
        var minY = sizeables.get(0).getBoundingBox().y;
        try {
    ...
    Sizeable.calculateWidth = function (sizeables, parentX) {
        ...
        var maxX = sizeables.get(0).getBoundingBox().getMaxX();
        try {
    ...
    Sizeable.calculateHeight = function (sizeables, parentY) {
        ...
        var maxY = sizeables.get(0).getBoundingBox().getMaxY();
        try {
