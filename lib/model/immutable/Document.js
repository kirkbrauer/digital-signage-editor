...
var Document = /** @class */ (function (_super) {
    ...
    Document.prototype.bringToFront = function (ids) {
        ...
        return this.set('nodes', List(tslib_1.__spread(nodes, this.nodes.filterNot(function (node) {
            return ids.includes(node.id);
        }))));
    };
    /**
    ...
    Document.prototype.sendToBack = function (ids) {
        var nodes = this.getNodesByID(ids);
        return this.set('nodes', List(tslib_1.__spread(this.nodes.filterNot(function (node) {
            return ids.includes(node.id);
        }), nodes)));
    };
    /**
