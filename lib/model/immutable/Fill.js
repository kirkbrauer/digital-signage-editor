...
var Fill = /** @class */ (function (_super) {
    ...
    Fill.prototype.getGradientTypeCSSString = function () {
        switch (this.gradientType) {
            case raw_1.GradientType.LINEAR: return 'linear-gradient';
            case raw_1.GradientType.RADIAL: return 'radial-gradient';
    ...
    Fill.prototype.getGradientCSSString = function () {
        ...
        var angle = this.gradientType === raw_1.GradientType.RADIAL ? 'circle' : (this.gradientAngle || 0) + "deg";
        try {
    ...
    Fill.prototype.getScaleModeCSSString = function () {
        switch (this.scaleMode) {
            case raw_1.ImageScaleMode.FIT: return 'contain';
            case raw_1.ImageScaleMode.FILL: return 'cover';
            case raw_1.ImageScaleMode.STRETCH: return '100% 100%';
            default: return undefined;
        }
    };
    Fill.prototype.getRepeatModeCSSString = function () {
        switch (this.repeatMode) {
            case raw_1.ImageRepeatMode.REPEAT: return 'repeat';
            case raw_1.ImageRepeatMode.REPEAT_X: return 'repeat-x';
            case raw_1.ImageRepeatMode.REPEAT_Y: return 'repeat-y';
