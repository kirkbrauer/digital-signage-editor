...
var Transformer = /** @class */ (function (_super) {
    ...
    Transformer.prototype.onStartDrag = function (e) {
        ...
        var onMouseMove = function (e) {
            ...
            var newPos = _this.calculatePosition(new Vector({ x: e.screenX, y: e.screenY }), initialPos, cursorStartPos);
    ...
    Transformer.prototype.onStartResize = function (e, dir) {
        ...
        var onMouseMove = function (e) {
            ...
            var newSize = _this.calculateSize(new Vector({ x: e.screenX, y: e.screenY }), initialSize, cursorStartPos, dir);
            // Calculate the new position
            var newPos = _this.calculateResizePos(new Vector({ x: e.screenX, y: e.screenY }), initialPos, cursorStartPos, dir);
            // Update the temporary state
            _this.setState({
                tempSize: new Size({
    ...
    Transformer.prototype.render = function () {
        ...
        return (React.createElement("div", { style: {
            ...
            !this.props.disabled && (React.createElement(React.Fragment, null,
                ...
                !this.props.disableRotation && (React.createElement("div", { style: {
                        top: -25,
                        position: 'absolute',
                        left: 'calc(50% - 4.5px)'
                    } },
                    React.createElement("div", { id: "rotate-line", style: {
                            height: 20,
                            width: 0,
                            top: 2,
                    ...
                    React.createElement("div", { id: "rotate", style: tslib_1.__assign({}, resizeHandleStyle, { cursor: 'crosshair', top: 0, left: 0 }), onMouseDown: function (e) { return _this.onStartRotate(e); } }))),
                !this.props.disableResize && (React.createElement(React.Fragment, null,
