    ...
    Text.prototype.renderContent = function (editing) {
        ...
        return (React.createElement(React.Fragment, null,
            React.createElement("div", { style: {
                ...
                React.createElement(Editor, { ref: this.editorRef, editorState: this.props.node.getEditorState(), onFocus: function () {
                        if (_this.dragging) {
                        ...
                        if (_this.props.onChange) {
                            var newNode = _this.props.node.setEditorState(editorState);
                            _this.props.onChange(newNode);
                        }
                    } })),
            React.createElement("div", { style: tslib_1.__assign({ width: '100%', height: '100%' }, this.getFillStyle(this.props.node.getFill()), this.getStrokeStyle(this.props.node.getStroke(), this.props.node.getStrokeWeight(), this.props.node.getStrokeAlign())) })));
    };
    return Text;
}(NodeComponent));
export default Text;
