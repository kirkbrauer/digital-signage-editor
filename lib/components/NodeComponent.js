...
var NodeComponent = /** @class */ (function (_super) {
    ...
    NodeComponent.prototype.render = function () {
        ...
        return (react_1.default.createElement(Transformer_1.default, { disabled: !this.props.selected || this.props.inGroup, position: node.getPosition(), size: node.getSize(), rotation: node.rotation, disableRotation: true, onDrag: function () {
                _this.dragging = true;
